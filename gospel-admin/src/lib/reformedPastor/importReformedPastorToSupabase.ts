...
import type { ParsedReformedPastor } from '@/lib/reformedPastor/ccelReformedPastorHtml'

/** Upsert Baxter *The Reformed Pastor* (`bxrp`) and rebuild `spurgeon_passage_index`. */
export async function importReformedPastorToSupabase(
  supabase: SupabaseClient,
  parsed: ParsedReformedPastor
): Promise<{
  slug: string

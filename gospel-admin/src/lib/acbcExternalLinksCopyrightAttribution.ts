...
export const ACBC_SCRIPTURE_INDEX_URL =
  'https://biblicalcounseling.com/resource-library/scripture-index/'
...
export const ACBC_EXTERNAL_RESOURCE_LINKS_ATTRIBUTION = {
  ...
  scriptureIndexLabel: 'scripture index',
  scriptureIndexHref: ACBC_SCRIPTURE_INDEX_URL,
  closing:

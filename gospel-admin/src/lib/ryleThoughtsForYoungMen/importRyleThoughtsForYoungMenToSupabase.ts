...
import type { ParsedRyleThoughtsForYoungMen } from '@/lib/ryleThoughtsForYoungMen/ccelRyleThoughtsForYoungMenHtml'
import type { SupabaseClient } from '@supabase/supabase-js'

/** Upsert J.C. Ryle *Thoughts for Young Men* (`jrym`) and rebuild `spurgeon_passage_index`. */
export async function importRyleThoughtsForYoungMenToSupabase(
  supabase: SupabaseClient,
  parsed: ParsedRyleThoughtsForYoungMen
): Promise<{
  slug: string

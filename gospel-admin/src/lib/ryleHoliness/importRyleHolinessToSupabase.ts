...
import type { ParsedRyleHoliness } from '@/lib/ryleHoliness/ccelRyleHolinessHtml'

/** Upsert J.C. Ryle *Holiness* (`jryh`) and rebuild `spurgeon_passage_index`. */
export async function importRyleHolinessToSupabase(
  supabase: SupabaseClient,
  parsed: ParsedRyleHoliness
): Promise<{
  slug: string

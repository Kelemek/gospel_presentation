...
import { subsectionCountForBerkhof } from '@/lib/berkhof/ccelBerkhofHtml'
import { profileDbTouchFields } from '@/lib/profileDbTouch'
import type { SupabaseClient } from '@supabase/supabase-js'

/** Upsert Berkhof *Systematic Theology* (`lbst`) and rebuild `spurgeon_passage_index`. */
export async function importBerkhofToSupabase(
  supabase: SupabaseClient,
  parsed: ParsedBerkhofSystematicTheology
): Promise<{
  slug: string
  ...
  return {
    ...
    subsectionCount: subsectionCountForBerkhof(gospelData),

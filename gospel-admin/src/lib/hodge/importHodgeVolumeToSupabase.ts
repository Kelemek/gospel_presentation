...
import type { ParsedHodgeVolume } from '@/lib/hodge/ccelHodgeHtml'
import { subsectionCountForHodge } from '@/lib/hodge/ccelHodgeHtml'
import { profileDbTouchFields } from '@/lib/profileDbTouch'
import type { SupabaseClient } from '@supabase/supabase-js'

/** Upsert one Hodge *Systematic Theology* volume and rebuild `spurgeon_passage_index`. */
export async function importHodgeVolumeToSupabase(
  supabase: SupabaseClient,
  parsed: ParsedHodgeVolume
): Promise<{
  slug: string
  ...
  return {
    ...
    subsectionCount: subsectionCountForHodge(gospelData),

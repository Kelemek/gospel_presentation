...
/** Upsert one parsed CCEL Edwards sermon into `profiles` and rebuild `spurgeon_passage_index`. */
export async function importCcelParsedEdwardsToSupabase(
  supabase: SupabaseClient,
  sermon: ParsedEdwardsSermonDiv1

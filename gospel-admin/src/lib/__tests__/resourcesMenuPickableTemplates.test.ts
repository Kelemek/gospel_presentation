...
describe('resourcesMenuPickableTemplates', () => {
  it('treats sermon, morneve, calvin, henry, and edwards slugs as corpus', () => {
    ...
    expect(isCcelCorpusProfileSlug('mhgen')).toBe(true)
  ...
  it('allows Edwards treatise and other book templates (not je sermon slugs)', () => {
    ...
    expect(isResourcesMenuPickableTemplateSlug('jrym')).toBe(true)

...
import type { ParsedPinkAttributes } from '@/lib/pinkAttributes/parsePinkAttributesSource'
import type { SupabaseClient } from '@supabase/supabase-js'

/** Upsert Pink *Attributes of God* (`pkag`) and rebuild `spurgeon_passage_index`. */
export async function importPinkAttributesToSupabase(
  supabase: SupabaseClient,
  parsed: ParsedPinkAttributes
): Promise<{
  slug: string

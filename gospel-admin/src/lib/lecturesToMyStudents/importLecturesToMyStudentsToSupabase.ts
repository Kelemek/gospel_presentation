...
import type { ParsedLecturesToMyStudents } from '@/lib/lecturesToMyStudents/parseGraceGemsLecturesSource'
import { profileDbTouchFields } from '@/lib/profileDbTouch'
import type { SupabaseClient } from '@supabase/supabase-js'

/** Upsert Spurgeon *Lectures to My Students* (`ltms`) and rebuild `spurgeon_passage_index`. */
export async function importLecturesToMyStudentsToSupabase(
  supabase: SupabaseClient,
  parsed: ParsedLecturesToMyStudents
): Promise<{
  slug: string

...
import type { ParsedAllOfGrace } from '@/lib/allOfGrace/ccelAllOfGraceHtml'

/** Upsert Spurgeon *All of Grace* (`aogr`) and rebuild `spurgeon_passage_index`. */
export async function importAllOfGraceToSupabase(
  supabase: SupabaseClient,
  parsed: ParsedAllOfGrace
): Promise<{
  slug: string

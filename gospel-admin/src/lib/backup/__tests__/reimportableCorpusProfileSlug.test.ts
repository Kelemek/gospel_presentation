...
describe('isReimportableCorpusProfileSlug', () => {
  it('matches CCEL corpus prefixes', () => {
    ...
    expect(isReimportableCorpusProfileSlug('ltms')).toBe(true)
    expect(isReimportableCorpusProfileSlug('bxrp')).toBe(true)
    expect(isReimportableCorpusProfileSlug('jryh')).toBe(true)
    expect(isReimportableCorpusProfileSlug('pkag')).toBe(true)
    expect(isReimportableCorpusProfileSlug('chst1')).toBe(true)
    expect(isReimportableCorpusProfileSlug('chst2')).toBe(true)
    expect(isReimportableCorpusProfileSlug('chst3')).toBe(true)
    expect(isReimportableCorpusProfileSlug('jrym')).toBe(true)

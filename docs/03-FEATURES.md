...
- **Narrow / small viewports** (below Tailwind **`xl`**): the promo card keeps a **~5.5in** max width but **no fixed height**—content defines height and the **page scrolls** for responsiveness. **QR codes** are **~88px** on screen (three across).
